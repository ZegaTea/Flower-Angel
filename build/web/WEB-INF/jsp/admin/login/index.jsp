...
<html lang="en" >
    ...
    <head>
        <link rel="icon" href="${ctxPath}/resources/webpage/icon/icons8_Protect.ico" > 
        ...
        <link href="${ctxPath}/resources/yeti/css/style.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <form method="POST" action="${ctxPath}/admin/login/check-login">
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" id="email" class="email" maxlength="256" name="name"/>
                <p class="helper helper1">Tên đăng nhập</p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup2">
                <label for="password">Mật khẩu:</label>
                <input type="password" id="password" class="password" name="pass" placeholder="Mật khẩu" />
            </div>
        ...
        <script src="${ctxPath}/resources/yeti/js/index.js" type="text/javascript"></script>
