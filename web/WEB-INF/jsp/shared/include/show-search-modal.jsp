...
<div class="modal fade bs-example-modal-lg" id="search-cart-id-form" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="GET" action="${ctxPath}/san-pham/tim-don-hang" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" id="id" name="id" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
